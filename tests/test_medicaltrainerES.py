...
class TestMedicalTrainer:
    ...
    @pytest.mark.medicaltrainer_es
    @pytest.mark.medicaltrainer
    @pytest.mark.smoke
    def test_medicalform_es(self):
        print("*******")
        print("TEST THE MEDICAL TRAINER FORM IN ES INSTANCE PASSED")
        print("*******")
        ...
        medicaltrainer.select_es_in_localization_dropdown()
        ...
        screen_valid_name = f'medicaltrainer_COM_valid_ES_{datetime.datetime.now()}.png'
        self.driver.get_screenshot_as_file(screen_valid_name)
        medicaltrainer.click_submit_button()
        screen_confirm_name = f'medicaltrainer_COM_confirm_ES_{datetime.datetime.now()}.png'
